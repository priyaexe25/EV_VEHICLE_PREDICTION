...
st.set_page_config(page_title="Electric Vehicle Forecast", layout="wide")
...
st.markdown("""
    <style>
        body {
            background-color: #ffeaf4; /* soft pastel pink */
            color: #1a1a1a;
        }

        .stApp {
            background: linear-gradient(to right, #e0f8e0, #fddde6);  /* pastel green to pink */
        }
